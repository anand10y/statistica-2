...
with st.sidebar:
    ...
    show_scatter_plots = st.checkbox( "Afișează grafice scatter (puncte) pentru clase și probe", value=True  # sau False dacă vrei ca checkbox-ul să fie debifat implicit
)
